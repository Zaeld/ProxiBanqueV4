...
public class IndexController {
	...
	private void createCustomersToEmployes() {
		final Customer c1 = new Customer("Bouvier", "Ludivine", "lud.bouvier@test.com", "55, rue Banaudon", "69001",
				"LYON", 2);
		final Customer c2 = new Customer("Le Guen", "Rébecca", "reb.leguen@test.com", "89, rue Marguerite", "69100",
				"VILLEURBANNE", 2);
		final Customer c3 = new Customer("Lebret", "Sylvain", "syl.lebret@test.com", "32, rue Pierre Motte", "69110",
				"SAINTE-FOY-LÈS-LYON", 2);
		final Customer c4 = new Customer("Corbin", "Remy", "remycorbin@test.com", "54, rue Pierre Motte", "69110",
				"SAINTE-FOY-LÈS-LYON", 2);
		final Customer c5 = new Customer("Besson", "Alphonse", "al.besson@test.com", "65, rue de la République",
				"69003", "LYON", 2);
		final Customer c6 = new Customer("Tang", "Daniel", "dtang@test.com", "15, rue Marguerite", "69100",
				"VILLEURBANNE", 3);
		final Customer c7 = new Customer("Beranger", "Juliette", "julietteberanger@test.com", "51, rue Marguerite",
				"69100", "VILLEURBANNE", 3);
		final Customer c8 = new Customer("Bernard", "Édouard", "ebernard@test.com", "85, Rue Marie De Médicis", "69300",
				"CALUIRE-ET-CUIRE", 3);
		final Customer c9 = new Customer("Delattre", "Roger", "rogerdelattre@test.com", "87, rue Grande Fusterie",
				"69500", "BRON", 4);
		final Customer c10 = new Customer("Lucas", "Laure", "laurelucas@test.com", "65, rue Banaudon", "69009", "LYON",
				4);
		final Customer c11 = new Customer("Hery", "Vladimir", "vhery@test.com", "8, rue Marguerite", "69100",
				"VILLEURBANNE", 4);
		final Customer c12 = new Customer("Dumoulin", "Nicolas", "nicdumoulin@test.com", "1, rue Pierre Motte", "69110",
				"SAINTE-FOY-LÈS-LYON", 4);
		final Customer c13 = new Customer("Durand", "Nicole", "nicoledurand@test.com", "76, Cours Marechal-Joffre",
				"69150", "DÉCINES-CHARPIEU", 4);
		final Customer c14 = new Customer("Parmentier", "Mireille ", "mireilleparmentier@test.com", "24, rue Banaudon",
				"69007", "LYON", 4);
		final Customer c15 = new Customer("Courty", "Nathalie ", "ncourty@test.com", "45, rue Gustave Eiffel", "69140",
				"RILLIEUX-LA-PAPE", 4);
		final Customer c16 = new Customer("Aubry", "Romain ", "romainaubry@test.com", "1, Rue Marie De Médicis",
				"69300", "CALUIRE-ET-CUIRE", 5);
		final Customer c17 = new Customer("Lorenzo", "Hélène", "hlorenzo@test.com", "14, rue de la Hulotais", "69800",
				"SAINT-PRIEST", 5);
		final Customer c18 = new Customer("Cohen", "Caroline ", "carocohen@test.com", "76, boulevard Amiral Courbet",
				"69600", "OULLINS", 5);
		final Customer c19 = new Customer("Crepin", "Madeleine ", "madeleinecrepin@test.com", "85, rue de la Hulotais",
				"69800", "SAINT-PRIEST", 5);
		final Customer c20 = new Customer("Prat", "Véronique ", "veroprat@test.com", "30, rue Banaudon", "69009",
				"LYON", 5);
